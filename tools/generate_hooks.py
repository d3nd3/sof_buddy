...
def generate_detours_header(detours, header_path, cpp_path, override_hooks):
...
def main():
    ...
    generate_detours_header(detours, detours_output, detours_cpp_output, override_hooks)
