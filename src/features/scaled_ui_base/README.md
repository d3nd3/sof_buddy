...
## Purpose
Provides shared infrastructure and base hooks for all scaled UI features (scaled_con, scaled_hud, scaled_text, scaled_menu). This feature contains common functionality including shared drawing hooks, vertex manipulation, and global state management.

**Note:** This feature automatically compiles when any of the sub-features (scaled_con, scaled_hud, scaled_text, scaled_menu) are enabled, ensuring the base infrastructure is always available.
...
This ensures base code compiles when any sub-feature is enabled.
