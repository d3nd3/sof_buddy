...
// Using declarations to bring namespace-scoped extern function pointers into scope
// These pointers are declared as extern in generated_detours.h and defined in generated_detours.cpp
// Using declarations allow convenient access without fully qualified names
using detour_Draw_StretchPic::oDraw_StretchPic;
using detour_Draw_Pic::oDraw_Pic;
