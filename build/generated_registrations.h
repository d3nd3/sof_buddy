...
extern void hkDraw_CharExtra(float x, float y, float scale, void* palette, int ch, detour_Draw_CharExtra::tDraw_CharExtra original);
...
extern void hkSCR_DrawCenterPrint(detour_SCR_DrawCenterPrint::tSCR_DrawCenterPrint original);
extern void hkSCR_DrawCinemaScope(detour_SCR_DrawCinemaScope::tSCR_DrawCinemaScope original);
...
extern void hkSCR_DrawPause(detour_SCR_DrawPause::tSCR_DrawPause original);
...
extern void hkcMissionStatus_Draw(void* self, detour_cMissionStatus_Draw::tcMissionStatus_Draw original);
